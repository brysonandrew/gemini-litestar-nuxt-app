...
<template>
	<div
		class="min-h-screen flex items-center justify-center bg-[rgb(var(--color-clay-light-bg))] dark:bg-[rgb(var(--color-clay-dark-bg))] transition-colors duration-300"
	>
		<div
			class="bg-[rgb(var(--color-clay-light-card))] dark:bg-[rgb(var(--color-clay-dark-card))] p-8 rounded-3xl shadow-clay-light dark:shadow-clay-dark w-full max-w-md transition-all duration-300"
		>
			<h1
				class="text-2xl font-bold mb-6 text-[rgb(var(--color-clay-light-text))] dark:text-[rgb(var(--color-clay-dark-text))] text-center"
			>
				Login
			</h1>
			<form @submit.prevent="login">
				<div class="mb-4">
					<label
						for="email"
						class="block text-[rgb(var(--color-clay-light-text))] dark:text-[rgb(var(--color-clay-dark-text))] text-sm font-medium mb-2"
						>Email</label
					>
					<input
						type="email"
			...
			<p
				class="mt-4 text-center text-[rgb(var(--color-clay-light-text))] dark:text-[rgb(var(--color-clay-dark-text))]"
			>
